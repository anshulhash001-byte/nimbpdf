          ...
          {tools.map((tool) => {
            ...
            return (
              <Link
                key={tool.slug}
                to={`/tools/${tool.slug}`}
                className={`group relative flex flex-col rounded-2xl border bg-white p-6 transition-all duration-200 ${
                  tool.isAvailable
                    ? 'border-gray-100 hover:border-brand-200 hover:shadow-lg hover:shadow-brand-100/50 hover:-translate-y-0.5'
      ...
      <section className="container py-16 md:py-24">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-600 to-brand-700 px-6 py-16 md:px-16">
          ...
          <div className="relative text-center">
            ...
            <Button size="lg" className="gap-2 bg-white text-brand-600 hover:bg-brand-50 shadow-lg">
              Get started free
